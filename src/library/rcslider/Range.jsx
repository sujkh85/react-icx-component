...
class Range extends React.Component {
  ...
  isNotControlled(props, state){
    if(state.handle === 0 || state.handle === (props.defaultValue.length -1)){
      return false
    }
    return true
  }
  ...
  onChange(state) {
    ...
    const isNotControlled = this.isNotControlled(props, state)
  ...
  onStart(position) {
    ...
    const isControll = !(boundNeedMoving === 0 || boundNeedMoving === (props.defaultValue.length -1))
